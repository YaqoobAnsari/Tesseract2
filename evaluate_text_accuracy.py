...
Output: Multifloor_Results/TextAccuracy/report.txt
"""
...
OUT_DIR = os.path.join(BASE_PATH, "Multifloor_Results", "TextAccuracy")
...
def detected_labels(stem):
    path = os.path.join(BASE_PATH, "Results", "Plots", "interpreter_detect",
