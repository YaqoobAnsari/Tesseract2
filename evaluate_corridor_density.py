...
Outputs (Multifloor_Results/CorridorDensity/):
...
OUT_DIR = os.path.join(BASE_PATH, "Multifloor_Results", "CorridorDensity")
SPACINGS = [80, 60, 40, 30, 20]   # densest (default) runs last


def load_post(stem):
    path = os.path.join(BASE_PATH, "Results", "Json", stem,
