%% Tesseract++: Journal Extension (ACM TSAS) - REVISION 1, colored working copy
...
\input{revision_macros}   % per-reviewer revision coloring
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\textwidth,height=0.52\textheight,keepaspectratio]{figures/knockout_curves.png}
...
\caption{\rall{Matching accuracy under synthetic perturbation. The assignment matcher holds 1.000 throughout while the nearest-neighbor baseline collapses as twin shafts approach.}}
\label{fig:matcher}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[height=0.6\textheight,keepaspectratio]{figures/stacked_floors.png}
