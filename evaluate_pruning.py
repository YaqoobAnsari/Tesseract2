...
Output: Multifloor_Results/PruningAblation/pruning_<image>.txt
"""
...
OUT_DIR = os.path.join(BASE_PATH, "Multifloor_Results", "PruningAblation")
...
def main():
    ...
    pre = load_graph_json(os.path.join(
        BASE_PATH, "Results", "Json", stem, f"{stem}_pre_pruning.json"))
    post = load_graph_json(os.path.join(
        BASE_PATH, "Results", "Json", stem, f"{stem}_post_pruning.json"))
