...
Outputs (results/evaluation/Downstream/<sequence>/):
...
def load_merged(sequence):
    path = os.path.join(MULTIFLOOR_RESULTS_DIR, "Jsons", sequence,
...
def main():
    ...
    out_dir = os.path.join(EVAL_RESULTS_DIR, "Downstream", args.sequence)
